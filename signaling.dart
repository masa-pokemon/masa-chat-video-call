...
class Signaling {
  ...
  bool muteMic() {
    if (_localStream != null) {
      return _localStream!.getAudioTracks()[0].enabled = !_localStream!.getAudioTracks()[0].enabled;
    }
    return false;
  }
  ...
  getLocalStream(String path) {
    return _localStream;
    //recorder.start(path,videoTrack: _localStream!.getVideoTracks().first);
  }
}
